...
## 2. Mental Model
- **Language (DSL):** Declarative, English-style syntax for apps, pages, flows, agents, models, memory, plugins, and UI components. Legacy headers like `model "foo":` are rejected; use the `is` form everywhere.
