...
3. **API keys**: set `OPENAI_API_KEY` if you want real model calls. Otherwise the deterministic dummy provider is used.
4. **Run tests**: `n3 test-cov` or `pytest -m "not slow"`.
