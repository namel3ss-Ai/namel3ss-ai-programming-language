...
_CONTRACTS: Dict[str, BlockContract] = {
    ...
    "page": BlockContract(
        ...
        optional_fields=(
            ...
            _opt("class_name", "string", "Optional CSS class for the page"),
            _opt("style", "mapping", "Inline style map for the page"),
        ),
    ...
    "section": BlockContract(
        ...
        optional_fields=(
            ...
            _opt("class_name", "string", "Optional CSS class for the section"),
            _opt("style", "mapping", "Inline style map for the section"),
        ),
